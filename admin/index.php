    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav" id="list" >
                ...
                <li>
                    <a href="index.php?page=input"  class="menu"><i class="fas fa-plus"></i> Input Data Produk</a>
                </li >
                <li>
                    <a href="index.php?page=data_produk" class="menu"><i class="fas fa-table"></i> Data Produk</a>
                </li>
                <li>
                    <a href="index.php?page=data_order" class="menu"><i class="fas fa-table"></i> Data Order</a>
                </li>
                <li>
                    <a href="index.php?page=data_cetak" class="menu"><i class="fas fa-table"></i> Data Cetak</a>
                </li>
                <li>
                ...
                <?php 
                	...
                	if (isset($_GET['page'])) {
                		if ($_GET['page'] == "profile") {
                            ...
                            include './view/input_produk.php';
                        } elseif ($_GET['page'] == "data_produk") {
                			include './view/table_produk.php';
                		} elseif ($_GET['page'] == "data_order") {
                            include './view/table_order.php';
                        } elseif ($_GET['page'] == "data_cetak") {
                            include './view/table_cetak.php';
