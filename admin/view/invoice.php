...
$datas = query("SELECT orders.id_orders, orders.jumlah_order, orders.id_product,  orders.id_pelanggan, product.gambar, product.nama_product, product.harga  FROM orders LEFT JOIN product ON orders.id_product = product.id_product WHERE orders.id_pelanggan = $id");
