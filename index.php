...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url('./images/header1.jpeg');width: fit-content; background-size: auto;">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Tempat Jual Beli Alat Kantor & Printing
								</span>
							</div>
				...
				<div class="item-slick1" style="background-image: url('./images/header2.jpg'); width: fit-content; background-size: cover;">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							<div class="layer-slick1 animated visible-false" data-appear="rollIn" data-delay="0">
								<span class="ltext-101 cl2 respon2">
									Peralatan Berkualiatas
								</span>
							</div>
								
							<div class="layer-slick1 animated visible-false" data-appear="lightSpeedIn" data-delay="800">
								<h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">
									<span style="background-color: black; color: white;">BARU</span>
								</h2>
							</div>
						</div>
					</div>
				...
				<div class="item-slick1" style="background-image: url('./images/header3.jpg');width: fit-content; background-size: cover; ">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
